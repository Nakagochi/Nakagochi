...
public class ListVsSetGui extends JFrame {
	...
	private JPanel createDemoPanel() {
		...
		JRadioButton rdbtnNewElement = new JRadioButton("New Element");
		rdbtnNewElement.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				demo.addElement(new ColoredSquare(10, Color.RED));

				textField.setText("New element has been added.");
			}
		});
		controlPanel.add(rdbtnNewElement);
